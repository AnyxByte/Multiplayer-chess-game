      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-neutral-900/50 backdrop-blur-xl border border-white/5 p-8 rounded-3xl shadow-2xl">
          <div className="space-y-4">
            ...
            <button className="w-full bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold py-4 rounded-xl transition-all transform active:scale-95 shadow-[0_0_20px_rgba(16,185,129,0.2)]">
              JOIN MATCH
            </button>
